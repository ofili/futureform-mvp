...
export default function InviteTeamMemberModal({ projectId, onClose }: { projectId: string; onClose: () => void }) {
  ...
  const handleInvite = async () => {
    ...
    try {
      ...
      toast.success(json.autoAccepted ? 'Team member added! 🎉' : 'Invitation sent! 📧');
      onClose();
    } catch (err: any) {
      console.error(err);
  ...
  const roleDescriptions: Record<string, string> = {
    ...
    EDITOR: 'Edit project and assessment data',
