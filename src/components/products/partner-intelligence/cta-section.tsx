...
export function PartnerIntelligenceCTA() {
  return (
    <section className="bg-gradient-to-b from-gray-950 to-midnight py-24 border-t border-gray-800/50">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className="inline-flex items-center space-x-2 mb-6 bg-amber-500/10 border border-amber-500/20 rounded-full px-4 py-1.5">
        ...
        <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">
          ...
          <br />
          <span className="text-amber-400">Partnership Strategy?</span>
        </h2>

        <p className="text-xl text-gray-400 mb-12 max-w-2xl mx-auto">
          Start evaluating partners with AI-powered intelligence. Get your first assessment in minutes.
        </p>
