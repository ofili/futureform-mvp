...
export default function FrameworkPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!formData.firstName || !formData.lastName || !formData.email || !formData.organization || !formData.sector || !formData.country) {
    ...
    try {
      const response = await fetch('/api/v1/framework/download', {
        method: 'POST',
        headers: {
      ...
      if (response && response.ok) {
        ...
        router.push(`/framework/download?token=${data.token}`);
      } else {
              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <div className="bg-gray-50 rounded-lg p-4 text-center cursor-help hover:bg-gray-100 transition-colors">
                    ...
                    <h4 className="font-semibold text-gray-900 text-sm">Reliability</h4>
                  </div>
                </TooltipTrigger>
                <TooltipContent>
              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <div className="bg-gray-50 rounded-lg p-4 text-center cursor-help hover:bg-gray-100 transition-colors">
                    ...
                    <h4 className="font-semibold text-gray-900 text-sm">Transparency</h4>
                  </div>
                </TooltipTrigger>
                <TooltipContent>
              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <div className="bg-gray-50 rounded-lg p-4 text-center cursor-help hover:bg-gray-100 transition-colors">
                    ...
                    <h4 className="font-semibold text-gray-900 text-sm">Governance</h4>
                  </div>
                </TooltipTrigger>
                <TooltipContent>
              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <div className="bg-gray-50 rounded-lg p-4 text-center cursor-help hover:bg-gray-100 transition-colors">
                    ...
                    <h4 className="font-semibold text-gray-900 text-sm">Competence</h4>
                  </div>
                </TooltipTrigger>
                <TooltipContent>
