 ...
 * 
 * Send invitations to respondents for an assessment (no credit consumption)
 */
export async function POST(
  ...
  try {
    ...
    // Create invitations (NO CREDIT CONSUMPTION HERE)
  ...
  try {
    await sendEmail({
      ...
      html: `
        ...
        <p>You have been invited to participate in an assessment: <strong>${assessment.title}</strong>.</p>
