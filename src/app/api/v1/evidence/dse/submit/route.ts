...
export async function POST(req: NextRequest) {
    try {
        ...
        const { organizationId, type, category, dataPayload, metadata, responseId } = body;
        ...
        const submission = await evidenceService.submitDSE(organizationId, {
            type,
            category,
            dataPayload,
            metadata,
        ...
        logger.error('Failed to submit DSE evidence', error as Error);
        return NextResponse.json(
